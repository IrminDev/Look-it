...
{/* If the NavLink is not active we have an special style for this situation */}
...
{/* If the NavLink is active we have an special style for this other situation */}
...
const Sidebar = ({user, closeToggle}) => {
    ...
    return (
        <div className="flex flex-col justify-between bg-white h-full overflow-y-scroll min-w-180 hide-scrollbar">
            <div className="flex flex-col">
             <Link 
                to="/"
                className="flex px-5 gap-2 my-6 pt-1 w-160 items-center"
