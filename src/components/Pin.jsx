                ...
                {postHovered && (
                    ...
                    >
                        <div className="flex items-center justify-between">
                            <div className="flex gap-2">
                                <a
                                    ...
                                    className="bg-white w-9 h-9 ml-1 rounded-full flex items-center justify-center text-dark text-xl opacity-75 hover:opacity-100 hover:shadow-md outline-none"
                                >
                        ...
                        <div className="flex justify-between items-center gap-2 w-full">
                            {/* If the destiantion link exists, the pin will have a link to the URL */}
                            {destination && (
                                <a 
                                    href={destination}
                                    target="_blank"
                                ...
                                >
                                    ...
                                    {destination.length > 20 ? `${destination.slice(0, 17)}...` : destination}
                                </a>
                            )}
